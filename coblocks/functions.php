...
function coblocks_scripts() {
	...
	wp_enqueue_style( 'coblocks-fonts', coblocks_fonts_url(), false, '1.2.4', 'all' );

	// Theme stylesheet.
	wp_enqueue_style( 'coblocks-style', get_stylesheet_uri(), false, '1.2.4', 'all' );

	// Scripts.
	wp_enqueue_script( 'coblocks-skip-link-focus-fix', get_theme_file_uri( '/assets/js/skip-link-focus-fix.js' ), array(), '1.2.4', true );
	wp_enqueue_script( 'coblocks-navigation', get_theme_file_uri( '/assets/js/navigation.js' ), array( 'jquery' ), '1.2.4', true );
	wp_enqueue_script( 'coblocks-global', get_theme_file_uri( '/assets/js/global.js' ), array( 'jquery' ), '1.2.4', true );
