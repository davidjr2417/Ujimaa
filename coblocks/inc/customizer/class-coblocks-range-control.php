...
class CoBlocks_Range_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_style( 'coblocks-range-control', get_parent_theme_file_uri( 'assets/css/customize-range-control.css' ), false, '1.2.4', 'all' );
		wp_enqueue_script( 'coblocks-range-control', get_parent_theme_file_uri( 'assets/js/customize-range-control.js' ), array( 'jquery' ), '1.2.4', true );
	}
