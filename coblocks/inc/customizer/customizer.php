...
function coblocks_customize_preview_js() {
	wp_enqueue_script( 'coblocks-customize-preview', get_theme_file_uri( '/assets/js/customize-preview.js' ), array( 'customize-preview' ), '1.2.4', true );
}
...
function coblocks_customize_controls_js() {
	wp_enqueue_script( 'coblocks-customize-controls', get_theme_file_uri( '/assets/js/customize-controls.js' ), array( 'customize-controls' ), '1.2.4', true );
}
...
function coblocks_customize_controls_css() {
	wp_enqueue_style( 'coblocks-customize-preview', get_theme_file_uri( '/assets/css/customize-controls.css' ), '1.2.4', true );
}
